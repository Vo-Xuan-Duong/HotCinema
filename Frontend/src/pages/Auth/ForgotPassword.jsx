                ...
                <div className="bg-card rounded-2xl shadow-xl overflow-hidden flex max-h-[90vh] lg:max-w-5xl max-w-[450px]">
                    <div className="w-full lg:flex-1 lg:max-w-[450px] p-6 lg:p-8 overflow-y-auto">
                        <div className="mb-6">
                            ...
                            <p className="text-muted-foreground text-sm font-medium text-center">Email đã được gửi</p>
                        </div>

                        <ResultState
                            state="success"
                            heading="Email đã được gửi!"
                            description={
            ...
            <div className="bg-card rounded-2xl shadow-xl overflow-hidden flex max-h-[90vh] lg:max-w-5xl max-w-[450px]">
                <div className="w-full lg:flex-1 lg:max-w-[450px] p-6 lg:p-8 overflow-y-auto">
                    <div className="mb-6">
                        ...
                        <p className="text-muted-foreground text-sm font-medium text-center">Khôi phục mật khẩu</p>
                    </div>
                    ...
                    <div className="w-full">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-muted-foreground text-sm leading-relaxed m-0 max-w-[400px] mx-auto">
                        ...
                        <div className="text-center pb-4 border-b border-border mb-4">
                            <Button
                                ...
                                variant="link"
                                onClick={handleBackToLogin}
                                className="text-muted-foreground text-xs p-0 h-auto font-medium hover:text-primary"
                            >
